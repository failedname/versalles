...
function detalleFac () {
  ...
  let print = detalle[0].estado === 'cerrada' ? `<a  id="print" dataa-id="${detalle[0].factura}" data-tooltip="Imprimir Copia" ><i  class="large circular link teal print icon"></i></a>`: null
