...
urlpatterns = [
    ...
    url(r'^remisiones/vivero/(?P<vivero_id>\w+)/todos/$', remionesAll, name='todosremisiones'),
    url(r'^remisiones/vivero/(?P<vivero_id>\w+)/crear/$', nuevaRemision.as_view(), name='crearremision'),
