document.addEventListener('DOMContentLoaded', () => {
  ...
  detalleFac()
  document.getElementById('print').addEventListener('click', copiaFactura)
  document.getElementById('ticket').addEventListener('click', copiaTicket)
})

function detalleFac() {
  let action = document.getElementById('action')
  let print = `<a  id="print" dataa-id="${detalle[0].factura}" data-tooltip="Imprimir Copia" ><i  class="large circular link teal print icon"></i></a><a  id="ticket" dataa-id="${detalle[0].factura}" data-tooltip="Imprimir Ticket" ><i  class="large circular link teal ticket icon"></i></a>`
...
function copiaFactura() {
  ...
  $.ajax({url: 'copia/', type: 'GET'}).done(function(datos) {
    let dat = datos.data
    let nume = datos.nume
...
function copiaTicket() {

  $.ajax({url: 'copiat/', type: 'GET'}).done(function(datos) {
    let dat = datos.data
    let nume = datos.nume
    let imagen = 'data:image/jpeg;base64,'

    var doc = new jsPDF('p', 'mm', [58, 237])
    doc.setFont("courier")
    doc.setFontType("bolditalic")
    var nit_vivero = dat[0].nit_vivero
    doc.setFontSize(7)
    doc.text(18, 25, `NIT:  ${nit_vivero}`)

    doc.addImage(imagen, 'jpeg', 10, 4, 37, 16)
    doc.text(3, 28, 'Km. 15 Via a San Agustin PITALITO')
    doc.text(3, 35, 'Factura de Venta:')
    var cod = dat[0].factura
    doc.text(45, 35, cod.toString())
    doc.setFillColor(150)
    doc.setTextColor(0)
    doc.setFontSize(10)
    doc.setTextColor(100)
